package com.hunllef.ui;

import com.hunllef.ui.components.Button;
...
@Slf4j
public class HunllefPluginPanel extends PluginPanel
{
	...
	@Inject
	public HunllefPluginPanel(HunllefPlugin plugin)
	{
		super(false);
		this.plugin = plugin;

		JLabel title = new JLabel("Hunllef");
