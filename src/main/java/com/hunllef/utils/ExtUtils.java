...
import com.hunllef.mappers.PrayerMap;
import com.hunllef.mappers.TabMap;
import com.hunllef.mappers.WidgetMap;
...
//	}
    ...
    public int getTabHotkey(TabMap tab)
    {
        assert client.isClientThread();
...
//	}
    ...
    public WidgetMap getPrayerWidgetInfo(String spell)
    {
        assert client.isClientThread();
...
//	}
    ...
    {
        assert client.isClientThread();
        return client.getWidget(PrayerMap.getWidget(spell).getPackedId());
    }
     ...
     * it will result in a crash/desynced thread.
     */
    public void click(Rectangle rectangle, boolean recalculateClientDimensions)
    {
        assert !client.isClientThread();
        Point point = getClickPoint(rectangle);
        click(point, recalculateClientDimensions);
    }

    public void click(Point p, boolean recalculateClientDimensions)
    {
        assert !client.isClientThread();

        if (recalculateClientDimensions && client.isStretchedEnabled())
        {
